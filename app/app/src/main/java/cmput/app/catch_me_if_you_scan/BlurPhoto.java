...
/**
 * This class is responsible for blurring the image of the background. If we do not do this, the
 * background is too sharp and the user cannot focus properly.
 **/
public class BlurPhoto {
    private Bitmap blurredImage;

    /**
     * Within the constructor, it will blurred the background.
     * The code is from...
    ...
    public BlurPhoto(Bitmap notBlurredImage) {
        ...
        Bitmap bitmap = notBlurredImage.copy(notBlurredImage.getConfig(), true);
