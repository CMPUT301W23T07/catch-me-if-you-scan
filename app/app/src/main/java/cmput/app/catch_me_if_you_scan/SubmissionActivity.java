...
//                            updateLocationViews();
    ...
    // Then we will compress the picture
...
//                    rotatedBitmap.compress(Bitmap.CompressFormat.JPEG, 80, stream); // Compress bitmap using RLE compression
